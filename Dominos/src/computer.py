...
#---------------------------------------------------
    ...
    def play(self, played_tiles):
        ...
        """
        suitable_tiles=self.get_suitable_tiles(played_tiles[0][0], played_tiles[-1][1])
...
#---------------------------------------------------
    ...
    def get_suitable_tiles(self, left_value, right_value):
        ...
        for tile in self._tiles_list :
            if (left_value in tile) or (right_value in tile) :
...
#---------------------------------------------------
    ...
    def get_best_tile(self, played_tiles, suitable_tiles):
        ...
        priority_list=[]
        left_value = played_tiles[0][0]
        right_value = played_tiles[-1][1]
        
        #build the priority_list
        priority_list = range(len(suitable_tiles))
        
        #fill the priority_list
        for j in range(len(suitable_tiles)) :
            
            dot_count=suitable_tiles[j][0] + suitable_tiles[j][1]
            DUO = 0
            ...
            if suitable_tiles[j][0] == suitable_tiles[j][1]:
                ...
                for tile in suitable_tiles :
                    if left_value in tile :
                        left_value_check = 1
                    if right_value in tile :
                        right_value_check = 1
